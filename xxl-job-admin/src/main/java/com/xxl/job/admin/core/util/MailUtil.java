...
public class MailUtil {
	...
	public static boolean sendMail(String toAddress, String mailSubject, String mailBody){
		...
		try {
			...
			email.setSSL(XxlJobAdminConfig.getAdminConfig().isMailSsl());
			email.setTLS(XxlJobAdminConfig.getAdminConfig().isMailTls());
			...
			email.setFrom(XxlJobAdminConfig.getAdminConfig().getMailSendFrom(), XxlJobAdminConfig.getAdminConfig().getMailSendNick());
